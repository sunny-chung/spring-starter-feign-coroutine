...
publishing {
    ...
    publications.withType<MavenPublication> {
        if (getExtraString("isCreateEmptyJavadocJar")?.toBooleanStrictOrNull() == true) {
        ...
        if (getExtraString("isCreateKotlinSourcesJar")?.toBooleanStrictOrNull() == true) {
            // Use existing "kotlinSourcesJar" task
